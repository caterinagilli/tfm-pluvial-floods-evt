...
tp_m <- nc_open("C:/Users/caterina.gilli/000/uni/TFM/data/tp_sto/stockholm_monthly_sum.nc")
rx1d <- nc_open("C:/Users/caterina.gilli/000/uni/TFM/data/tp_sto/stockholm_rx1d_sum.nc")
rx5d <- nc_open("C:/Users/caterina.gilli/000/uni/TFM/data/tp_sto/stockholm_rx5d_sum.nc")
...
dates
monthly_df <- data.frame(year = years, month = months, date=dates, tp = ncvar_get(tp_m, "tp")*1000/88, rx1d = ncvar_get(rx1d, "tp")*1000/88, rx5d = ncvar_get(rx5d, "tp")*1000/88)
...
plot(NA, xlim = range(daily_df$tp), ylim = c(0, 0.8), xlab = "tp", ylab = "Density", main = "")
...
# Create an empty plot
plot(NA, xlim = range(monthly_df$tp), ylim = c(0, 0.02), xlab = "tp", ylab = "Density", main = "")
